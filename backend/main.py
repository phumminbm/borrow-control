...
def _ensure_fonts():
    ...
    fonts = {
        "TH":  ("FreeSerif.ttf",     "https://github.com/opensourcedesign/fonts/raw/master/gnu-freefont_freefont-20120503/FreeSerif.ttf"),
        "THB": ("FreeSerifBold.ttf", "https://github.com/opensourcedesign/fonts/raw/master/gnu-freefont_freefont-20120503/FreeSerifBold.ttf"),
    }
    for name, (fname, url) in fonts.items():
        fpath = f"{_FONT_DIR}/{fname}"
        if not os.path.exists(fpath):
            _urllib_request.urlretrieve(url, fpath)
