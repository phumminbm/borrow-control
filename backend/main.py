...
def _ensure_fonts():
    ...
    pdfmetrics.registerFont(TTFont("TH",  "/usr/share/fonts/truetype/freefont/FreeSerif.ttf"))
    pdfmetrics.registerFont(TTFont("THB", "/usr/share/fonts/truetype/freefont/FreeSerifBold.ttf"))
